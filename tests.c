...
void test_isValidDate(void) {
    ...
    isValidDate(0, 6, 2000);
    isValidDate(32, 6, 2000);
    isValidDate(15, 0, 2000);
    isValidDate(15, 13, 2000);
    isValidDate(15, 6, 1919);
    isValidDate(15, 6, 2011);
    printf("-----------------------\n");
    TEST_PASS();
}
...
void test_VTable_getPayment(void) {
    ...
    printPersonPayment((PersonBase*)t);
...
int runAllTests(void) {
    printf("\n========================================\n");
    printf("        " COLOR_GREEN "ЗАПУСК ТЕСТОВ ПРОЕКТА" COLOR_RESET "\n");
    printf("========================================\n");
    ...
    printf("\n========================================\n");
    printf("              " COLOR_YELLOW "ИТОГИ ТЕСТОВ" COLOR_RESET "\n");
    printf("========================================\n");
